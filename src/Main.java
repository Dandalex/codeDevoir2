...
class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        int[][] labyrinthe = charger("labyrinthe11.txt"); // ici on peut choisir le  labyrinthe parmi: "labyrinthe1.txt", "labyrinthe11.txt", "labyrinthe2.txt",  "labyrinthe21.txt", "labyrinthe3.txt", "labyrinthe31.txt".
